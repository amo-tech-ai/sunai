...
const Header: React.FC<{ onNavigate: (screen: Screen) => void }> = ({ onNavigate }) => (
    <header className="absolute top-0 left-0 right-0 z-10 py-4 px-8 flex justify-between items-center">
        <div className="font-bold text-2xl text-sunai-dark">Sun AI</div>
        <nav className="hidden md:flex items-center gap-6 text-gray-700 font-medium">
            <a href="#values" className="hover:text-sunai-orange transition-colors">Features</a>
            <a href="#events" className="hover:text-sunai-orange transition-colors">Events</a>
            <a href="#perks" className="hover:text-sunai-orange transition-colors">Perks</a>
        </nav>
