    ...
    <div className="flex h-screen bg-sunai-beige">
      <aside className="w-64 bg-white p-4 border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 space-y-2 mt-8">
            ...
            <NavItem icon={CalendarIcon} label="Browse Events" screen={Screen.Events} currentScreen={currentScreen} setCurrentScreen={setCurrentScreen} />
            ...
            <NavItem icon={PerksIcon} label="Perks" screen={Screen.Perks} currentScreen={currentScreen} setCurrentScreen={setCurrentScreen} />
        </nav>
