...
const PerkCard: React.FC<{ perk: Perk }> = ({ perk }) => (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col group transition-all hover:shadow-lg hover:-translate-y-1">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-200">
             ...
             <button className="bg-sunai-dark text-white font-semibold py-2 px-4 rounded-lg hover:bg-black transition-colors text-sm">
                Claim Perk
            </button>
        </div>
    </div>
...
const PerksScreen: React.FC<PerksScreenProps> = ({ perks }) => {
    return (
        <div>
            <div className="mb-8">
